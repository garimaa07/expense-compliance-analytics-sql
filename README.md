...
## 📸 Screenshots & Analytics Results

Here are screenshots of the analytics queries run on the database. Each screenshot shows **real query results**, demonstrating insights generated by the system.
